...
/**
 * Ответ на запрос на регистрацию расчетных документов
 * 
 * <p>Java class for PutPayDocsRs complex type.
 * 
...
@XmlType(name = "PutPayDocsRs", propOrder = {
    "result",
    "errors"
})
public class PutPayDocsRs
    extends Message
{
